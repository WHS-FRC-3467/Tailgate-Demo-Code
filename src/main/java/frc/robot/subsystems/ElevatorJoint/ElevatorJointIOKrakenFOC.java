...
import frc.robot.subsystems.ElevatorJoint.ElevatorJointIO.ElevatorJointIOInputs;

public class ElevatorJointIOKrakenFOC implements ElevatorJointIO {
    // Hardware
    ...
    public ElevatorJointIOKrakenFOC() {
        m_motor = new TalonFX(ElevatorJointConstants.ID_LEADER);
        m_follower = new TalonFX(ElevatorJointConstants.ID_FOLLOWER);
    ...
    // Update Inputs
    public void updateInputs(ElevatorJointIOInputs inputs) {
