...
public class ShooterHoodIOPneumaticFOC implements ShooterHoodIO {
    // Hardware
    DoubleSolenoid m_shooterPiston = new DoubleSolenoid(PneumaticsModuleType.CTREPCM, ShooterHoodConstants.PHConstants.HoodForwardSolenoid, ShooterHoodConstants.PHConstants.HoodReverseSolenoid);
